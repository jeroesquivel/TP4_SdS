...
% Animaciones embebidas como mp4 (paquete multimedia, macro \movie).
% Los mp4 se generan automáticamente con `scripts/render_animations.sh`
% (Java → PNG → ffmpeg → H.264). Funciona con Adobe Acrobat (Reader/Pro)
% y con pympress. El poster (frame estático) se ve en cualquier visor.
\usepackage{multimedia}

% \simvideo{poster sin ext}{video sin ext}
%   poster: figures/N=100   (.png)
%   video:  videos/N=100    (.mp4)
\newlength{\vidW}
\newlength{\vidH}
\newcommand{\simvideo}[2]{%
  \setlength{\vidH}{0.62\textheight}%
  \setlength{\vidW}{\vidH}% animaciones cuadradas (480x480)
...
% \figorplaceholder{ruta sin ext}{opciones \includegraphics}{nota: qué hacer}
...
\newcommand{\videoorplaceholder}[3]{%
  % #1=poster sin ext, #2=video sin ext, #3=nota
...
% Cita en la esquina inferior izquierda (lejos del nº de página del footer)
